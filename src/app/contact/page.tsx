...
import { Linkedin, ExternalLink, Mail, MessageSquare } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
              Professional inquiries, research collaborations, speaking engagements, and academic
              discussions are welcome via LinkedIn.
            </p>
          </motion.div>
          ...
          >
            <a
              ...
              className="group block p-8 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 hover:border-primary-300 dark:hover:border-primary-700 transition-all hover:shadow-xl text-center"
            >
          ...
          >
            <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-center">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Interested in behavioral attribution research? Reach out via LinkedIn to discuss potential collaborations.
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-center">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Available for cybersecurity conferences, academic seminars, and industry speaking engagements.
              </p>
            </div>
          </motion.div>
        </div>
