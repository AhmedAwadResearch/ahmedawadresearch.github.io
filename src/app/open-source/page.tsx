...
import { Github, ExternalLink, Code2, Star, GitFork, BookOpen } from "lucide-react";
...
const repos = [
  {
    ...
    description:
      "A formal framework for behavioral digital attribution. Axiomatic system, mathematical framework, algorithmic catalog, and validation infrastructure.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
              All research, frameworks, and tools are developed under open-source principles, enabling
              independent validation, replication, and community contribution.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {repos.map((repo, i) => (
              <motion.a
                ...
                variants={fadeInUp}
                custom={i}
                className="group p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 hover:border-primary-300 dark:hover:border-primary-700 transition-all hover:shadow-lg hover:-translate-y-1"
              >
