...
const articles = [
  {
    ...
    publication: "Cyber Defense Magazine",
    year: 2026,
    url: "#",
    description:
      "An analysis of threat actor psychology and decision-making patterns, providing CISOs with insights to anticipate and prepare for sophisticated cyber attacks.",
  },
  {
    ...
    url: "#",
    description:
      "Examining the evolving financial ecosystem supporting cybercrime, from ransomware-as-a-service to cryptocurrency-based money laundering operations.",
  },
  {
    title: "How Blockchain Could Disrupt Industries",
    publication: "Blocktelegraph.io",
    year: 2023,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
              Industry articles, security analyses, and thought leadership pieces published in
              cybersecurity magazines and technology platforms.
            </p>
          </motion.div>
          ...
          <div className="space-y-6">
            {articles.map((article, i) => (
              <motion.a
                ...
                variants={fadeInUp}
                custom={i}
                className="block p-6 lg:p-8 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 hover:border-primary-300 dark:hover:border-primary-700 transition-all hover:shadow-lg group"
              >
